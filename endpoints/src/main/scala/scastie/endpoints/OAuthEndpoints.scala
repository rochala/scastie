...
object OAuthEndpoints {
  ...
  case class OptionalUserSession(
    jwtCookie: Option[JwtCookie],
    xsrfCookie: Option[XSRFCookie],
    xsrfHeader: Option[XSRFHeader]
  ) extends Session
  ...
  val login: PublicEndpoint[Option[String], Unit, String, Any] = endpoint.get
    .in("login")
  ...
  val logout: PublicEndpoint[Unit, Unit, ResponseCookies, Any] = endpoint.get
    .in("logout")
    .out(statusCode(StatusCode.SeeOther))
    .out(header(Header.cacheControl(CacheDirective.NoCache)))
  ...
  val loginGithub: PublicEndpoint[(String, String), ErrorWithRedirect, ResponseCookiesWithRedirect, Any] = endpoint.get
    .in("callback")
  ...
  val secureEndpoint: Endpoint[UserSession, Unit, String, Unit, Any] = endpoint
  ...
  val optionalSecureEndpoint: Endpoint[OptionalUserSession, Unit, String, Unit, Any] = endpoint
